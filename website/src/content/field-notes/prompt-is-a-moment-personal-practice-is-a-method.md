...
decisionRule: >-
  ...
  use it.
practicalTakeaway: >-
  A downloadable, editable Personal Practice Canvas. Its fields—task,
  outcome, use and non-use boundary, context/data boundary, tool or
  method, examples, verification, known failures, authority boundary,
  value signal, and review point—give an individual a small working system
