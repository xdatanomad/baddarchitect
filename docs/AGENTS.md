...
`docs/` contains durable project direction, approved milestones, content planning, architecture notes, decisions, and operating workflows. Treat these files as project source-of-truth documents, not raw notes or publishable articles.
...
- Preserve decision history and avoid silently replacing prior rationale.
- If moving or reorganizing strategy content, preserve the original text and leave a clear pointer when practical.
